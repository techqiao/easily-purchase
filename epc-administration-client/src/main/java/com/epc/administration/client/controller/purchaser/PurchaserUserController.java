...
public class PurchaserUserController {
    ...
    public Result deletePurchaserDetailInfo(@RequestParam("whereId") Long whereId) {
    ...
    public Result selectAllPurchaserByPage(@RequestBody ClientQueryDetailIfo clientQueryDetailIfo){
