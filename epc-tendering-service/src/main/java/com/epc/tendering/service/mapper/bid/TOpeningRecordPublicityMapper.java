...
public interface TOpeningRecordPublicityMapper {
    ...
    @Select("Select b.id from t_opening_record_publicity b left join t_opening_record t on t.id = b.bid_announcement_id " +
            "where t.purchase_project_id =#{procurementProjectId} and b.process_status='released'")
